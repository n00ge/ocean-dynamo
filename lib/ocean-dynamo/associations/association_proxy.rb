module OceanDynamo
  module Associations
    ...
    # OceanDynamo::Associations::HasManyAssociation.
    #
    # The <tt>@target</tt> object is not \loaded until needed. For example,
    #
    #   blog.posts.count
    #
    # is computed by calling DynamoDB directly and does not trigger by itself the
    ...
    class AssociationProxy #:nodoc:
      ...
      private
        ...
        #
        # OceanDynamo::RecordNotFound is rescued within the method, and it is
        ...
        def raise_on_type_mismatch(record)
          unless record.is_a?(@reflection.klass) || record.is_a?(@reflection.class_name.constantize)
            ...
            raise OceanDynamo::AssociationTypeMismatch, message
          end
        end
