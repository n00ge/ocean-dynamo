...
* Updating of tables commented out - smarter logic to add and remove global secondary
  indices is needed, otherwise AWS will barf (where DynamoDB Local does not...).
